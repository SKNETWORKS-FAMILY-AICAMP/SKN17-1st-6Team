...
with top1:
    ...
    img = Image.open("C:/skn_17/sixth_sense/top_image/kia_image/sorento.png")
    st.image(img)
...
with top2:
    ...
    img = Image.open("C:/skn_17/sixth_sense/top_image/kia_image/carnibal.jpg")
    st.image(img)
...
with top3:
    ...
    img = Image.open("C:/skn_17/sixth_sense/top_image/kia_image/spotigi.png")
    st.image(img)
...
with top4:
    ...
    img = Image.open("C:/skn_17/sixth_sense/top_image/kia_image/seltos.png")
    st.image(img)
...
with top5:
    ...
    img = Image.open("C:/skn_17/sixth_sense/top_image/kia_image/rei.png")
    st.image(img)
